...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'jackalope' ); ?></a>
    ...
    <nav class="navbar navbar-default navcolor rollovernav customnav purgeborder">
        ...
        <!--//////Toggle//////-->
            ...
            <button type="button" class="hamburger hamburger--spring navbar-toggle btn-2 btn-2a " data-toggle="collapse" data-target="#hamburgerfillins">
        ...
        <div class="collapse navbar-collapse customnav rollovernav topdawg" id="hamburgerfillins">
            ...
            <div class="nav navbar-nav navbar-left customnav topdawg purgeborder">
                <a href="<?php echo get_home_url(); ?>/blog/"><span data-hover="My Weblog">My Weblog&nbsp;    </span></a>

                <a href="<?php echo get_home_url(); ?>/consultation/"><span data-hover="Free Consultation!">Free Consultation!&nbsp;    </span></a>
            </div>
