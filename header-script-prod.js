...
(function() {
    ...
    function Ba(a, b) {
        ...
        if (a) {
            ...
            for (c = d = 0; e = f[c]; c++) {
                var v = e.className,
                    R;
                if (R = "function" == typeof v.split) R = 0 <= fa(v.split(/\s+/), a);
                R && (h[d++] = e)
            }
            h.length = d;
            return h
    ...
    var I = "StopIteration" in k ? k.StopIteration : {
    ...
    var Va = 0;
    w("ytDomDomGetNextId", m("ytDomDomGetNextId") || function() {
        return ++Va
    });
    var Wa = {
    ...
    var Xa = m("ytEventsEventsCounter") || {
        count: 0
    };
    ...
    function $a(a, b, c) {
        ...
        if (a && (a.addEventListener || a.attachEvent)) {
            ...
            if (!e) {
                ...
                var h = f ? function(d) {
                    d = new P(d);
                    if (!Ca(d.relatedTarget, function(b) {
                            return b == a
    ...
    function fb(a, b) {
        ...
        var c = z(b.getElementsByTagName("yt:" + a)),
            d = "yt-" + a,
            e = b || document;
        d = z(e.querySelectorAll && e.querySelector ? e.querySelectorAll("." + d) : Ba(d, b));
        return ia(c, d)
    }

    function T(a, b) {
        return "yt:" == a.tagName.toLowerCase().substr(0, 3) ? a.getAttribute(b) : a ? a.dataset ? a.dataset[cb(b)] : a.getAttribute("data-" + b) : null
    }

    function gb(a, b) {
        L.H.apply(L, arguments)
    };
    ...
    function ib(a, b, c) {
        U || (U = {}, $a(window, "message", u(a.g, a)));
        U[c] = b
    }
    hb.prototype.g = function(a) {
        if (a.origin == V(this, "host") || a.origin == V(this, "host").replace(/^http:/, "https:")) {
            ...
            if (a = U[b.id]) a.B = !0, a.B && (y(a.u, a.C, a), a.u.length = 0), a.I(b)
        }
    };
    ...
    function jb(a, b) {
        ...
        var v = a.v();
        v.enablejsapi = window.postMessage ?
            1 : 0;
        window.location.host && (v.origin = window.location.protocol + "//" + window.location.host);
        v.widgetid = a.g;
    ...
    function kb(a) {
        ib(a.b, a, a.g);
        a.c = ab(u(a.G, a));
        $a(a.a, "load", u(function() {
            window.clearInterval(this.c);
            this.c = ab(u(this.G, this))
        }, a))
    }
    ...
    g.C = function(a) {
        ...
        for (c = 0; c < b.length; c++) try {
            ...
            if (d.name && "SyntaxError" == d.name) Ua(d, "WARNING");
            else throw d;
        }
    };
    Ka(new La);
        ...
        y(b, function(a) {
            this[a] || ("getCurrentTime" == a ? this[a] = function() {
                ...
                if (1 == this.j.playerState) {
                    var b = (ea() / 1E3 - this.j.currentTimeLastUpdated_) * this.j.playbackRate;
                    0 < b && (a += Math.min(b, 1))
                }
                return a
            } : nb(a) ? this[a] = function() {
                this.j = {};
                this.i = {};
                X(this, a, arguments);
                return this
    ...
    g.P = function() {
        ...
        a = '<iframe width="' + a + '" height="' + b + '" src="' + c + '" frameborder="0" gesture="media" allow="encrypted-media" allowfullscreen></iframe>';
        return a
    };
    g.O = function(a) {
    ...
    w("YT.scan", eb);
    w("YT.subscribe", function(a, b, c) {
        L.subscribe(a, b, c);
        db[a] = !0;
        for (var d in Q) lb(Q[d], a)
    });
    w("YT.unsubscribe", function(a, b, c) {
        Ha(a, b, c)
    });
    w("YT.Player", Y);
    w("YT.Thumbnail", Z);
...
domReady(function() {
    ...
    (function (jQuery) {
        ...
        jQuery.fn.slabText = function (options) {

            // Add the slabtexted classname to the body to initiate the styling of
            // the injected spans
            jQuery("body").addClass("slabtexted");
            ...
            return this.each(function () {
                ...
                var jQuerythis = jQuery(this),
                    self = this,
                    settings = jQuery.extend({}, jQuery.fn.slabText.defaults, options),
                    keepSpans = jQuery("span.slabtext", jQuerythis).length,
                    words = keepSpans ? [] : String(jQuery.trim(jQuerythis.text())).replace(/\s{2,}/g, " ").split(" "),
                    origFontSize = null,
                    idealCharPerLine = null,
                    resizeThrottle = null,
                    viewportWidth = jQuery(window).width(),
                    headLink = jQuerythis.find("a:first").attr("href") || jQuerythis.attr("href"),
                    linkTitle = headLink ? jQuerythis.find("a:first").attr("title") : "";
                ...
                var grabPixelFontSize = function () {
                    var dummy = jQuery('<div style="display:none;font-size:1em;margin:0;padding:0;height:auto;line-height:1;border:0;">&nbsp;</div>').appendTo(jQuerythis),
                        emH = dummy.height();
                    dummy.remove();
                    return emH;
                };
                ...
                var resizeSlabs = function resizeSlabs() {
                    ...
                    var parentWidth = jQuerythis.width(),
                        fs;
                    ...
                    jQuerythis.removeClass("slabtextdone slabtextinactive");
                    ...
                    if (settings.viewportBreakpoint && settings.viewportBreakpoint > viewportWidth
                        ...
                        jQuerythis.addClass("slabtextinactive");
                        return;
                    }
                    ;
                    ...
                    if (!keepSpans && (settings.forceNewCharCount || fs != origFontSize)) {
                        ...
                        if (newCharPerLine != 0 && newCharPerLine != idealCharPerLine) {
                            ...
                            while (wordIndex < words.length) {
                                ...
                                lineLength = jQuery.trim(finalText).length;

                                // HTML-escape the text
                                finalText = jQuery('<div/>').text(finalText).html()
                                ...
                                finalText = jQuery.trim(finalText);
                            ...
                            jQuerythis.html(lineText.join(" "));
                            // If we have a headLink, add it back just inside our target, around all the slabText spans
                            if (headLink) {
                                jQuerythis.wrapInner('<a href="' + headLink + '" ' + (linkTitle ? 'title="' + linkTitle + '" ' : '') + '/>');
                            }
                            ;
                        }
                        ;
                    ...
                    jQuery("span.slabtext", jQuerythis).each(function () {
                        var jQueryspan = jQuery(this),
                            innerText = jQueryspan.text(),
                        ...
                        ratio = parentWidth / jQueryspan.width();
                        fontSize = parseFloat(this.style.fontSize) || origFontSize;

                        jQueryspan.css("font-size", Math.min((fontSize * ratio).toFixed(settings.precision), settings.maxFontSize) + "px");

                        // Do we still have space to try to fill or crop
                        diff = !!settings.postTweak ? parentWidth - jQueryspan.width() : false;

                        // A "dumb" tweak in the blind hope that the browser will
                        // resize the text to better fit the available space.
                        // Better "dumb" and fast...
                        if (diff) {
                            jQueryspan.css((wordSpacing ? 'word' : 'letter') + '-spacing', (diff / (wordSpacing ? innerText.split(" ").length - 1 : innerText.length)).toFixed(settings.precision) + "px");
                        }
                        ;
                    });
                    ...
                    jQuerythis.addClass("slabtextdone");
...
//# sourceMappingURL=header-script-prod.js.map